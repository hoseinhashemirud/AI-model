...
The motor commands would be: $u_s=0.7 , u_v=0.25$, as $v_l=u_v*(1+u_s)$ and $v_r=u_v*(1-u_s)$ $\rightarrow$ $v_l=0.425,v_r=0.075$ --> left motor 42.5% and right motor 7.5% is on and the robot turns right. It means the push on the right wheel is less.<br>
